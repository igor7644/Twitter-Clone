<div class="col-md-7 mr-auto posts">
    <div class="row insidePost">
            <p class="post-author"><a href="{{ asset('/user/'.$post->user->id) }}" class="usernamePost">{{ $post->user->username }}</a><span class="hours"> &nbsp {{ Carbon\Carbon::parse($post->created_at)->diffForHumans()}} </span></p>
